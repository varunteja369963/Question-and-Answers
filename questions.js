            ...
            if (grpname.length !== 70) {
                ...
                $.ajax({
                   ...
                   if (data === '1') {
                    ...
                    var path = encodeURIComponent('questions.js/(sub)questions.php/error=1');
                    $.post("senderror.php", 
                    {
                   ...
                   window.location = "loginform.html";
                    ...
                    var errormessage = encodeURIComponent(data);
                    var path = encodeURIComponent('questions.js/(sub)questions.php/error=2');
                    $.post("senderror.php", 
                    {
                     'errormessage': errormessage,
                     'path': path  
                    ...
                    var errormessage = encodeURIComponent(data);
                    var path = encodeURIComponent('questions.js/(sub)questions.php/error=else');
                    $.post("senderror.php", 
                    {
                     'errormessage': errormessage,
                     'path': path  

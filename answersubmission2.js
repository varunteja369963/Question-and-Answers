                ...
                $.ajax({
                        ...
                        success: function(data){
                             if (data === '1') {
                                ...
                                var path = encodeURIComponent('answersubmission2.js/(sub)answersubmission2.php/error=else');
                                $.post("senderror.php", 
                                {
             ...
             $.ajax({
                     ...
                     success: function(data){
                       ...
                       location.reload(true);
                        ...
                        var errormessage = encodeURIComponent(data);
                        var path = encodeURIComponent('answersubmission2.js/(sub)updatinganswer3.php/error=else');
                        $.post("senderror.php", 
                        {
                         'errormessage': errormessage,
                         'path': path  

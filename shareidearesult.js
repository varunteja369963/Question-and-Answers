...
$(document).ready(function(){
    $.ajax({
       ...
       window.location = "loginform.html";
        ...
        var path = encodeURIComponent('shareidearesult.js/(sub)securitynetwork2.php/error=else');
        $.post("senderror.php", 
        {
    ...
    $.ajax({
     ...
     $("#content_window").find(".answers").find('input[type=text]').each(function(){
        ...
        $(this).replaceWith( "<div><center><iframe class = 'vedioembbed' src='https://www.youtube.com/embed/"+string+"' frameborder= '0' allow='autoplay; encrypted-media' allowfullscreen></iframe></center></div>" );
                ...
                var errormessage = encodeURIComponent(data);
                var path = encodeURIComponent('shareidearesult.js/(sub)siappend.php/error=else');
                $.post("senderror.php", 
                {
                 'errormessage': errormessage,
                 'path': path  
...
$("#got_points").html(updated_value);
    ...
    var errormessage = encodeURIComponent(data);
    var path = encodeURIComponent('shareidearesult.js/(sub)siaddpoints.php/error=else');
    $.post("senderror.php", 
    {
     'errormessage': errormessage,
     'path': path  
...
$.ajax({
    ...
    success: function(bef_data){
       ...
       $("#got_points").html(updated_value);
            ...
            var errormessage = encodeURIComponent(data);
            var path = encodeURIComponent('shareidearesult.js/(sub)simunuspoints.php/error=else');
            $.post("senderror.php", 
            {
             'errormessage': errormessage,
             'path': path  
...
$.ajax({
   ...
   if (data === '1') {
    ...
    var errormessage = encodeURIComponent(data);
    var path = encodeURIComponent('shareidearesult.js/(sub)siansweraddpoints.php/error=else');
    $.post("senderror.php", 
    {
     'errormessage': errormessage,
     'path': path  
    ...
    success: function(bef_data){
        ...
        if (data === '1') {
           ...
           $(".answer_total_points").find("."+ca3ka9zqkdi).html(updated_value);
            ...
            var errormessage = encodeURIComponent(data);
            var path = encodeURIComponent('shareidearesult.js/(sub)sianswermunuspoints.php/error=else');
            $.post("senderror.php", 
            {
             'errormessage': errormessage,
             'path': path  
...
$(document).ready(function(){
    $("#edit_question").click(function(){
        ...
        window.location = "shareidea.html?questionid=" + questionid;
    });
});

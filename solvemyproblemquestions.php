...
include_once('connection4.php');
   ...
   $select2 = "SELECT `uuid`, `tags`, `precisequestion`, `askeduser`, `dateandtime`, `points` FROM `solvemyproblemquestions` WHERE id BETWEEN $minid AND $maxid ORDER BY id DESC";
   ...
   while ($row2 = $result2->fetch_assoc()) {
    ...
    echo '<div id = "specific_question">';
       echo '<a href = "displayresult.php?uuid=' . $uuid . '">';
